                        ...
                        <div class="row d-flex align-items-stretch">
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="input_product_title" value="{{ old('title', $product->title) }}"
                                        name="title" type="text" class="form-control @error('title') is-invalid @enderror"
                                        placeholder="" />
                                    @error('title')
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="input_product_slug" value="{{ old('slug', $product->slug) }}" name="slug"
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="input_product_price" value="{{ old('price', $product->price) }}"
                                        name="price" type="text" class="form-control @error('price') is-invalid @enderror"
                                        placeholder="Rp." />
                                    @error('price')
                                        <span class="invalid-feedback">
                                            <strong>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="select_product_status" name="status"
                                        ...
                                        @foreach ($statuses as $key => $value)
                                            <option value="{{ $key }}"
                                                {{ old('status', $product->status) == $key ? 'selected' : null }}>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
