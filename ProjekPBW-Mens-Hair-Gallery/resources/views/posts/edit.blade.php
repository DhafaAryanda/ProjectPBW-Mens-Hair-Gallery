                ...
                <div class="row d-flex align-items-stretch">
                   <div class="col-md-8">
                      ...
                      <div class="form-group">
                         ...
                         <input id="input_post_title" value="{{ old('title', $post->title) }}" name="title" type="text" class="form-control @error('title') is-invalid @enderror"
                            placeholder="" />
                            @error('title')
                      ...
                      <div class="form-group">
                         ...
                         <input id="input_post_slug" value="{{ old('slug', $post->slug) }}" name="slug" type="text" class="form-control @error('slug') is-invalid @enderror" placeholder="Auto generate"
                            readonly />
                            @error('slug')
                               <span class="invalid-feedback">
                                  <strong>
